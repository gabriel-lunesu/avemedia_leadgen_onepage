...
function Header() {
  useEffect(() => {
    parallaxie(`header.parallaxie`, 0.2, 0);
  }, []);
        ...
        <div className="row">
          ...
          <div className="col-lg-4 d-flex align-items-end justify-content-end justify-end">
            <div className="d-flex align-items-center">
                  ...
                  <div className="circle-button hover-anim">
                    <div className="rotate-circle fz-30 text-u">
                      <svg className="textcircle" viewBox="0 0 500 500">
                        ...
                        <text>
                          <textPath xlinkHref="#textcircle" textLength="900">Scroll Down - Explore More -</textPath>
                        </text>
                      </svg>
                    </div>
                    <div className="arrow">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                          ...
                          fill="currentColor" transform="scale(1,-1) translate(0,-18)"></path>
                    </svg>
              ...
              <div>
                <h6 className="sub-title">Scroll Down <br /> <u>Get In Touch!</u></h6>
              </div>
            </div>
          </div>
        </div>
